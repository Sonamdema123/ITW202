...
//import static com.google.android.material.card.MaterialCardView.LOG_TAG;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null){
            ...
            if(isVisible){
                ...
                mReplyTextView.setText(savedInstanceState.getString("reply_state_msg"));
    ...
    protected void onSaveInstanceState(@NonNull Bundle outState){
        ...
        //save state data to the instance state bundle
        if (mReplyHeadTextView.getVisibility() == View.VISIBLE){
            outState.putBoolean("reply_state", true);
            outState.putString("reply_state_msg", mReplyTextView.getText().toString());
        }
    }
}